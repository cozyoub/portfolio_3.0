...
export const works = [
  ...
  },
  {
    ...
    detailDescription:
      "김해문화재단 산하 각 사이트의 정체성과 특성을 고려하여 디자인을 기획하고 구현하였습니다. 각 기관의 성격에 맞는 컬러 및 구성 요소를 활용해 통일성과 차별화를 모두 잡고자 하였으며, 퍼블리싱 또한 함께 진행하였습니다. 특히 김해문화재단 메인 사이트는 웹접근성 인증을 취득하여, 사용자 친화성과 접근성 측면에서도 우수한 결과를 달성하였습니다. 특히 패밀리사이트 전반에 적용되는 공통 레이아웃과 메인 화면 구조를 먼저 설계하여, 이를 기반으로 팀원들이 각 산하기관별 서브페이지를 진행할 수 있는 기틀을 마련했습니다.",
     solutionTag: ["HTML", "GSAP", "Jsp" , "웹접근성 취득"],
    scopeTags: [
      { label: "공통 레이아웃", color: "pink" },
      { label: "메인 퍼블리싱", color: "coral" },
